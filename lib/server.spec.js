...
describe('Server:', () => {
  ...
  const greeterProto = 'spec/protos/greeter.proto';
  ...
  beforeEach(() => {
    ...
    builder.addService(greeterProto, 'testapp.greeter.GreeterService', greeterServiceMock);
  ...
  describe('constructor()', () => {
    ...
    describe('getOptions()', () => {
      ...
      describe('when server was initialized with options', () => {
        beforeEach(() => {
          const options = {'host': '1.1.1.1', 'port': 9999};
