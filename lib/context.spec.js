...
describe('Context:', () => {
  ...
  describe('.req', () => {
    it('should return call request object', () => {
      expect(context.req).toEqual(call.request);
    });
  });
  ...
  describe('.meta', () => {
    it('should return call metadata', () => {
      expect(context.meta).toEqual(call.metadata);
    });
  });
  ...
  describe('.status', () => {
    it('should return the grpc.status object', () => {
      expect(context.status).toEqual(grpc.status);
    });
  });
});
