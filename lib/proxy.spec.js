...
describe('Proxy:', () => {
  ...
  describe('middleware', () => {
    ...
    describe('when middleware method returns', () => {

      describe('a promise that', () => {
        describe('resolve', () => {
          ...
          describe('with a value', () => {
            ...
            it('should not be called the implementation', (done) => {
      ...
      describe('when middleware method return a value', () => {
        describe('with nothing', () => {
          it('should wait to continue to the next middleware', (done) => {
            const promise = new Promise((resolve) => {
              process.nextTick(() => {
    ...
    describe('when middleware method does not return anything', () => {
      it('should wait to continue to the next middleware', (done) => {
        const promise = new Promise((resolve) => {
          process.nextTick(() => {
            resolve();
