...
describe('Proxy:', () => {
  ...
  describe('when implementation method is inherited from another class', () => {
    it('should be treated as any other method', () => {
  ...
  describe('each method', () => {
    ...
    describe('callback is undefined (streams)', () => {
      ...
      describe('error handler throws an error', () => {
        it('should emit the error', (done) => {
          const expectedError = 'secondError';
          personServiceMock.list = Spy.throwError('My Internal Server Error');
  ...
  describe('middleware', () => {
    ...
    describe('returns nothing (undefined)', () => {
      it('the next middleware should be called', (done) => {
      ...
      it('the implementation should be called', (done) => {
    ...
    describe('returns a value', () => {
      ...
      it('should callback with the value', (done) => {
        const expectedResult = {'response': 'my response'};
        middlewareMock.globalMiddleware.method = Spy.returnValue(expectedResult);
    ...
    describe('returns a promise', () => {
      describe('that resolves', () => {
        describe('with nothing', () => {
          it('the next middleware should be called', (done) => {
            middlewareMock.globalMiddleware.method = Spy.resolve();
            proxy.list(call, () => {
              expect(middlewareMock.packageMiddleware.method).toHaveBeenCalledTimes(1);
              done();
            });
          ...
          it('the implementation should be called', (done) => {
            middlewareMock.packageMiddleware.method = Spy.resolve();
            proxy.list(call, () => {
              expect(personServiceMock.list).toHaveBeenCalledTimes(1);
              done();
            });
        ...
        describe('with a value', () => {
          it('should stop the middleware chain', (done) => {
            middlewareMock.globalMiddleware.method = Spy.resolve('do not continue with middleware');
            proxy.list(call, () => {
              expect(middlewareMock.packageMiddleware.method).not.toHaveBeenCalled();
              done();
            });
          ...
          it('should callback with the resolved value', (done) => {
            const expectedResult = {'response': 'my response'};
            middlewareMock.globalMiddleware.method = Spy.resolve(expectedResult);
            proxy.list(call, (error, result) => {
              expect(result).toEqual(expectedResult);
              expect(error).toBeNull();
              done();
      ...
      describe('that rejects', () => {
        describe('with nothing', () => {
          it('should callback with error', (done) => {
            ...
            middlewareMock.globalMiddleware.method = Spy.reject();
            proxy.list(call, (error) => {
        ...
        describe('with an error', () => {
          it('should callback with an specific error', (done) => {
            ...
            middlewareMock.globalMiddleware.method = Spy.reject(expectedError);
            proxy.list(call, (error) => {
              expect(error).toEqual(expectedError);
              done();
            });
  ...
  describe('error handlers', () => {
    ...
    describe('package error handlers', () => {
    ...
    describe('service error handlers', () => {
      it('should call all the corresponding error handler methods', (done) => {
        const expectedError = new Error('error');
        proxy.list(call, (error) => {
    ...
    describe('method corresponding error handlers', () => {
      it('should call all error handler methods', (done) => {
        const expectedError = new Error('error');
        proxy.list(call, (error) => {
    ...
    describe('returns nothing (undefined)', () => {
      it('the next error handler should be called', (done) => {
      ...
      describe('that resolves', () => {
        describe('with nothing', () => {
          it('should wait to continue to the next error handler', (done) => {
            errorHandlerMock.globalErrorHandler.method = Spy.resolve();
            proxy.list(call, () => {
              expect(errorHandlerMock.packageErrorHandler.method).toHaveBeenCalledTimes(1);
              done();
            });
        ...
        describe('with a value', () => {
          it('should stop the error handler chain', (done) => {
            errorHandlerMock.globalErrorHandler.method = Spy.resolve('value');
            proxy.list(call, () => {
              expect(errorHandlerMock.packageErrorHandler.method).not.toHaveBeenCalled();
              done();
            });
      ...
      describe('that rejects', () => {
        describe('with nothing', () => {
          it('should callback with error', (done) => {
            ...
            errorHandlerMock.globalErrorHandler.method = Spy.reject();
            proxy.list(call, (error) => {
              expect(error).toEqual(expectedError);
              done();
            });
        ...
        describe('with an error', () => {
          it('should callback with an specific error', (done) => {
            const expectedError = 'error';
            middlewareMock.globalMiddleware.method = Spy.reject('error');
            proxy.list(call, (error) => {
              expect(error).toEqual(expectedError);
              done();
            });
    ...
    describe('throws an error', () => {
      ...
      it('should stop the middleware chain', (done) => {
        errorHandlerMock.globalErrorHandler.method = Spy.throwError();
        proxy.list(call, () => {
          expect(errorHandlerMock.packageErrorHandler.method).not.toHaveBeenCalled();
          done();
        });
