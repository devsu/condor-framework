...
describe('Proxy:', () => {
  ...
  describe('each method', () => {
    ...
    describe('each middleware', () => {
      it('should be called before the implementation', () => {
        middleware = [middlewareMock.globalMiddleware, middlewareMock.packageMiddleware];
  ...
  describe('proxy has error handlers', () => {
    let call;
    beforeEach(() => {
      call = {'a': 1};
    ...
    describe('when implementation throws an error', () => {
      it('should be called the error handler', (done) => {
        proxy.list(call, () => {
    ...
    it('should call all global error handlers', (done) => {
      ...
      proxy.list(call, (error) => {
        expect(errorHandlerMock.globalErrorHandler.method).toHaveBeenCalledTimes(1);
        expect(errorHandlerMock.globalErrorHandler.method).toHaveBeenCalledWith(expectedError);
        expect(error).toEqual(expectedError);
        done();
      });
    });
    ...
    it('should call all the corresponding package error handler methods', (done) => {
      ...
      proxy.list(call, (error) => {
        ...
        expect(errorHandlerMock.packageErrorHandler.method).toHaveBeenCalledWith(expectedError);
        expect(error).toEqual(expectedError);
        done();
      });
    });
    ...
    it('should call all the corresponding service error handler methods', (done) => {
      ...
      proxy.list(call, (error) => {
        ...
        expect(errorHandlerMock.serviceErrorHandler.method).toHaveBeenCalledWith(expectedError);
        expect(error).toEqual(expectedError);
        done();
      });
    });
    ...
    it('should call all the corresponding error handler methods', (done) => {
      ...
      proxy.list(call, (error) => {
        ...
        expect(errorHandlerMock.methodErrorHandler.method).toHaveBeenCalledWith(expectedError);
        expect(error).toEqual(expectedError);
        done();
      });
    });
    ...
    describe('when error object is modified by an error handler', () => {
      it('should pass the modified error to the next error handler', (done) => {
        ...
        const expectedError = new Error('global error');
        proxy.list(call, () => {
          expect(errorHandlerMock.packageErrorHandler.method).toHaveBeenCalledWith(expectedError);
          done();
        });
