...
describe('Proxy:', () => {
  let serviceDefinition, proxy, personServiceMock, middlewareMock, middleware, errorHandlerMock,
    errorHandlers, call, expectedProperties, expectedError, expectedResponse, error;
  ...
  function runTests(customServiceDefinition) {
    ...
    describe('each middleware', () => {
      ...
      describe('when middleware catch the error', () => {
        beforeEach(() => {
          expectedError = new Error('No response send after error was handled');
        });

        it('should throw no response error', (done) => {
